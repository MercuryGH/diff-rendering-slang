...
class SoftRas(Function):
    ...
    def forward(
        ...
        ctx.image = image
        ctx.save_for_backward(bg_color, metallic, output)
    ...
    def backward(
        ...
        bg_color, metallic, output = ctx.saved_tensors
        ...
        soft_ras.Main.bwd(
            ...
            metallic=(metallic, grad_metallic),
        ...
        print(grad_bg_color, grad_metallic)

        return None, None, None, None, None, None, grad_bg_color, grad_metallic, None
